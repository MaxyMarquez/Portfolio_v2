        ...
        <>
            <section id='section3' className='grid place-content-center py-20  scroll-smooth'>
                ...
                <a
                    ...
                    target='_blank'
                >
                    <p className='text-gray-300 text-2xl bg-transparent'>{t('projects.food')}</p>
                    <picture className='bg-transparent w-full'>
                        <img className='lg:w-full lg:h-72 border-2 rounded-md border-slate-500 mt-2 bg-[#ffffff33]' src={food} alt='' />
                        <div className='lg:w-full mt-2 lg:mt-0 bg-transparent'>
                            ...
                            <div className='flex justify-center lg:justify-start gap-2 mt-4 bg-transparent w-full'>
                                ...
                                <span className='relative group bg-transparent'>
                                    <Icon icon="simple-icons:express" className='w-5 h-5 bg-transparent' />
                                    <span
                                        className="absolute hidden group-hover:flex -top-3 -translate-y-full w-max p-2 bg-gray-700 rounded-lg text-center text-white text-sm transform -translate-x-1/2 left-1/2 after:content-[''] after:absolute after:left-1/2 after:top-[100%] after:-translate-x-1/2 after:border-8 after:border-x-transparent after:border-b-transparent after:border-t-gray-700">
                                        Express
                                    </span>
                ...
                <a
                    ...
                    target='_blank'
                >
                    <p className='text-gray-300 text-2xl bg-transparent'>{t('projects.trendyShop')}</p>
                    <picture className='bg-transparent w-full'>
                        <img className='lg:w-full lg:h-72 border-2 rounded-md border-slate-500 mt-2 bg-[#ffffff33]' src={trendy} alt='' />
                        <div className='lg:w-full mt-2 lg:mt-0 bg-transparent'>
                            <p className='flex font-sans text-slate-400 text-base mt-2 bg-transparent w-full'>
                ...
                >
                    <picture className='bg-transparent w-full'>
                        ...
                        <img className='lg:w-full lg:h-72 border-2 rounded-md border-slate-500 mt-2 bg-[#ffffff33] object-cover' src={ToDoList} alt='' />
