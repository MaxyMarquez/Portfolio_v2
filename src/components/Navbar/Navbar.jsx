...
import cv from "../../assets/Marquez Maximiliano.pdf";
    ...
    <>
      <header className="lg:sticky lg:top-0 lg:h-screen lg:flex lg:flex-col lg:justify-between lg:w-full lg:py-24">
        ...
        <div>
          ...
          <h2 className="text-3xl text-slate-400 font-mono mt-2">
            {t("role")}
          </h2>
            ...
            <ul className="mt-16 w-max">
              {targetIds.map((id) => (
                <li key={id}>
                  ...
                  >
                    <span
                      className={`mr-4 h-px transition-all group-hover:w-16 group-hover:bg-white group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none ${
                        id === activeSection
                          ? "mr-4 h-px w-16 bg-white "
                          : "bg-slate-500 w-8"
                      }`}
                    ></span>
                    <span
                      className={`font-mono text-sm font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200 ${
                        id === activeSection ? "text-white " : "text-slate-500"
                      }`}
                    >
                      {t(id)}
                    </span>
        ...
        <div className="flex  gap-4 mt-2 lg:mt-0">
          ...
          <a
            href="mailto:maxy.marquez90@gmail.com"
            target="_blank"
            className="group"
          >
